      ...
      <section className="mb-6 flex flex-col md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <div className="mt-1 space-y-1">
            ...
            <p className="text-sm leading-snug text-foreground/90 italic">— Deliberately going against the grain for far right-tail outcomes</p>
          </div>
        </div>
                            ...
                            <li>
                              ...
                              >
                                ...
                                <span className="text-muted-foreground text-xs md:text-sm">
                                  • {post.slug === "lessons-from-george-bonaci"
